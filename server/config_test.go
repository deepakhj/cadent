...
`
	...
	serverlisters["statsd-example"] = [][]string{
		[]string{"udp://192.168.59.103:8126", "udp://192.168.59.103:8136", "udp://192.168.59.103:8146"},
		[]string{"udp://192.168.59.104:8126", "udp://192.168.59.104:8136", "udp://192.168.59.104:8146"},
	}
	serverlisters["graphite-example"] = [][]string{
		[]string{"tcp://192.168.59.103:2003", "tcp://192.168.59.103:2004", "tcp://192.168.59.103:2005"},
	}
	serverlisters["graphite-backend"] = [][]string{
		[]string{"tcp://192.168.59.105:2003", "tcp://192.168.59.105:2004", "tcp://192.168.59.105:2005"},
	}
	...
	Convey("Given a config file", t, func() {
		...
		confs, _ := ParseConfigFile("../example-config.toml")
