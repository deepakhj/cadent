...
func TestAccumualtorAccumulator(t *testing.T) {
	...
	Convey("Graphite to graphite -> graphite accumulator should be ok", t, func() {
		...
		err = grph_acc.Accumulate.ProcessLine([]byte("moo.goo.max 2 123123"))
		err = grph_acc.Accumulate.ProcessLine([]byte("moo.goo.max 5 123123"))
		err = grph_acc.Accumulate.ProcessLine([]byte("moo.goo.max 10 123123"))

		err = grph_acc.Accumulate.ProcessLine([]byte("stats.counters.goo 2 123123"))
		err = grph_acc.Accumulate.ProcessLine([]byte("stats.counters.goo 5 123123"))
		err = grph_acc.Accumulate.ProcessLine([]byte("stats.counters.goo 10 123123"))

		err = grph_acc.Accumulate.ProcessLine([]byte("stats.gauges.goo 2 123123"))
		err = grph_acc.Accumulate.ProcessLine([]byte("stats.gauges.goo 5 123123"))
		err = grph_acc.Accumulate.ProcessLine([]byte("stats.gauges.goo 10 123123"))
