...
<head>
	...
	<title>ConstHash Tracker</title>
	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
	<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css">
	<link rel="stylesheet" href="h//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap-theme.min.css">
...
<div class="container">
	...
	<div class="page-header">
		<div class="row">
			<div class="col-sm-12"><h1>ConstHasher Tracker <small>Up: <span id="uptime_sec"></span></small></h1></div>
		</div>
	</div>
	<div class="row">
	...
	<div class="footer small">
		...
		<ul class="list-inline links pull-left">
			&copy; MyFitnesspal 2015 - Bo Blanton
		</ul>
...
<script type="text/javascript">
	...
	var TickInterval=5 // stats every 5 second are rendered by the consthasher
