...
func TestMarshalUnmarshalMetricTag(t *testing.T) {
	v := MetricTag{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgMetricTag(b *testing.B) {
	v := MetricTag{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgMetricTag(b *testing.B) {
	v := MetricTag{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalMetricTag(b *testing.B) {
	v := MetricTag{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeMetricTag(t *testing.T) {
	v := MetricTag{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeMetricTag(b *testing.B) {
	v := MetricTag{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeMetricTag(b *testing.B) {
	v := MetricTag{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
