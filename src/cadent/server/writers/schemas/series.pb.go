...
/// NOTE: this was edited to include the Msgpack tag names
...
type MetricTag struct {
	Tag []string `protobuf:"bytes,1,rep,name=tag" json:"tag,omitempty, msg:"tag,omitempty""`
}
...
type MetricType struct {
	Type string `protobuf:"bytes,1,req,name=type" json:"type" msg:"type"`
}
...
type MetricName struct {
	Metric   string       `protobuf:"bytes,1,req,name=metric" json:"metric"  msg:"metric"`
	Id       uint64       `protobuf:"varint,2,opt,name=id" json:"id"  msg:"id"`
	Uid      string       `protobuf:"bytes,3,opt,name=uid" json:"uid"  msg:"uid"`
	Tags     []*MetricTag `protobuf:"bytes,13,rep,name=tags" json:"tags,omitempty"  msg:"tags,omitempty"`
	MetaTags []*MetricTag `protobuf:"bytes,14,rep,name=meta_tags" json:"meta_tags,omitempty" msg:"meta_tags,omitempty"`
}
...
type MetricValue struct {
	Time  int64   `protobuf:"varint,1,req,name=time" json:"time" msg:"time"`
	Min   float64 `protobuf:"fixed64,2,opt,name=min" json:"min"  msg:"min"`
	Max   float64 `protobuf:"fixed64,3,opt,name=max" json:"max"  msg:"max"`
	Last  float64 `protobuf:"fixed64,4,opt,name=last" json:"last"  msg:"last"`
	Sum   float64 `protobuf:"fixed64,5,req,name=sum" json:"sum"  msg:"sum"`
	Count int64   `protobuf:"varint,6,req,name=count" json:"count"  msg:"count"`
}
...
type SeriesMetric struct {
	Id         uint64       `protobuf:"varint,2,req,name=id" json:"id"  msg:"id"`
	Uid        string       `protobuf:"bytes,3,req,name=uid" json:"uid"  msg:"uid"`
	Time       int64        `protobuf:"varint,4,req,name=time" json:"time"  msg:"time"`
	Metric     string       `protobuf:"bytes,5,req,name=metric" json:"metric"  msg:"metric"`
	Encoding   string       `protobuf:"bytes,6,req,name=encoding" json:"encoding"  msg:"encoding"`
	Data       []byte       `protobuf:"bytes,7,req,name=data" json:"data"  msg:"data"`
	Resolution uint32       `protobuf:"varint,8,opt,name=resolution" json:"resolution"  msg:"resolution"`
	Ttl        uint32       `protobuf:"varint,9,opt,name=ttl" json:"ttl"  msg:"ttl"`
	Tags       []*MetricTag `protobuf:"bytes,13,rep,name=tags" json:"tags,omitempty"  msg:"tags,omitempty"`
	MetaTags   []*MetricTag `protobuf:"bytes,14,rep,name=meta_tags" json:"meta_tags,omitempty"  msg:"meta_tags,omitempty"`
}
...
type SingleMetric struct {
	...
	Time       int64        `protobuf:"varint,4,req,name=time" json:"time" msg:"time"`
	Metric     string       `protobuf:"bytes,5,req,name=metric" json:"metric" msg:"metric"`
	Min        float64      `protobuf:"fixed64,6,opt,name=min" json:"min" msg:"min"`
	Max        float64      `protobuf:"fixed64,7,opt,name=max" json:"max" msg:"max"`
	Last       float64      `protobuf:"fixed64,8,opt,name=last" json:"last" msg:"last"`
	Sum        float64      `protobuf:"fixed64,9,req,name=sum" json:"sum" msg:"sum"`
	Count      int64        `protobuf:"varint,10,req,name=count" json:"count" msg:"count"`
	Resolution uint32       `protobuf:"varint,11,opt,name=resolution" json:"resolution" msg:"resolution"`
	Ttl        uint32       `protobuf:"varint,12,opt,name=ttl" json:"ttl" msg:"ttl"`
	Tags       []*MetricTag `protobuf:"bytes,13,rep,name=tags" json:"tags,omitempty" msg:"tags,omitempty"`
	MetaTags   []*MetricTag `protobuf:"bytes,14,rep,name=meta_tags" json:"meta_tags,omitempty" msg:"meta_tags,omitempty"`
}
...
type UnProcessedMetric struct {
	Time     int64        `protobuf:"varint,1,req,name=time" json:"time" msg:"time"`
	Metric   string       `protobuf:"bytes,2,req,name=metric" json:"metric" msg:"metric"`
	Min      float64      `protobuf:"fixed64,3,opt,name=min" json:"min" msg:"min"`
	Max      float64      `protobuf:"fixed64,4,opt,name=max" json:"max" msg:"max"`
	Last     float64      `protobuf:"fixed64,5,opt,name=last" json:"last" msg:"last"`
	Sum      float64      `protobuf:"fixed64,6,req,name=sum" json:"sum" msg:"sum"`
	Count    int64        `protobuf:"varint,7,req,name=count" json:"count" msg:"count"`
	Tags     []*MetricTag `protobuf:"bytes,13,rep,name=tags" json:"tags,omitempty" msg:"tags,omitempty"`
	MetaTags []*MetricTag `protobuf:"bytes,14,rep,name=meta_tags" json:"meta_tags,omitempty" msg:"meta_tags,omitempty"`
}
...
type RawMetric struct {
	Time     int64        `protobuf:"varint,1,req,name=time" json:"time" msg:"time"`
	Metric   string       `protobuf:"bytes,2,req,name=metric" json:"metric"  msg:"metric"`
	Value    float64      `protobuf:"fixed64,3,req,name=value" json:"value"  msg:"value"`
	Tags     []*MetricTag `protobuf:"bytes,13,rep,name=tags" json:"tags,omitempty"  msg:"tags,omitempty"`
	MetaTags []*MetricTag `protobuf:"bytes,14,rep,name=meta_tags" json:"meta_tags,omitempty"  msg:"meta_tags,omitempty"`
}
